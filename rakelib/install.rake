...
oppropriate command to elevate permissions (eg su, sudo).
        ...
        install_capi_include "#{BUILD_CONFIG[:stagingdir]}#{BUILD_CONFIG[:include18dir]}",
                             "#{prefixdir}#{BUILD_CONFIG[:include18dir]}"
        install_capi_include "#{BUILD_CONFIG[:stagingdir]}#{BUILD_CONFIG[:include19dir]}",
                             "#{prefixdir}#{BUILD_CONFIG[:include19dir]}"
        install_capi_include "#{BUILD_CONFIG[:stagingdir]}#{BUILD_CONFIG[:include20dir]}",
