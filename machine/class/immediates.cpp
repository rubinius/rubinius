...
namespace rubinius {
  ...
  void FalseClass::Info::mark(STATE, Object* obj, std::function<Object* (STATE, Object*, Object*)> f) { }

  void FalseClass::Info::show(STATE, Object* self, int level) {
    std::cout << "'false'" << std::endl;
  }

  void TrueClass::Info::mark(STATE, Object* obj, std::function<Object* (STATE, Object*, Object*)> f) { }

  void TrueClass::Info::show(STATE, Object* self, int level) {
    std::cout << "'true'" << std::endl;
  }

  void NilClass::Info::mark(STATE, Object* obj, std::function<Object* (STATE, Object*, Object*)> f) { }
