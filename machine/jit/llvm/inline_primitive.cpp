...
namespace rubinius {
    ...
    void fixnum_compare_operation(MathOperation op) {
      ...
      switch(op) {
        ...
        case cGreaterThanEqual:
          ...
          break;
        default:
          throw LLVMState::CompileError("unknown Fixnum operation");
      }
    ...
    void float_op(MathOperation op) {
      ...
      switch(op) {
        ...
        case cMod:
          ...
          break;
        default:
          throw LLVMState::CompileError("unknown Float operation");
      }
  ...
  void Inliner::inline_intrinsic(Class* klass, ClassData data, CompiledCode* code, int which) {
    ...
    case 1: // Tuple#swap
      ...
      break;
    default:
      throw LLVMState::CompileError("unknown inline intrinsic");
    }
  }
}
