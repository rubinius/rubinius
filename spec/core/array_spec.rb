...
context "Array instance method" do
  ...
  specify "& should create an array with elements in order they are first encountered" do
  ...
  specify "| should return an array of elements that appear in either array (union)" do
    ([] | []).should == []
    ([1, 2] | []).should == [1, 2]
    ([] | [1, 2]).should == [1, 2]
...
describe "Array#[]" do
  it_should_behave_like(array_slice_specs, :[])
end

describe "Array#slice" do
  it_should_behave_like(array_slice_specs, :slice)
end
