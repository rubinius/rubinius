...
describe "CApiCVGetSetSpecs" do
  ...
  it "rb_cv_get should return nil when there's no class variable" do
    lambda { @s.rb_cv_get(CVTest, "@@no_variable") }.should raise_error(NameError)
    lambda { @s.rb_cvar_get(CVTest, "@@no_variable") }.should raise_error(NameError)
  end

  it "rb_cv_set should set a class variable" do
    @s.rb_cv_set(CVTest, "@@class_variable_1", 1)
    @s.rb_cv_get(CVTest, "@@class_variable_1").should == 1
    @s.rb_cvar_set(CVTest, "@@class_variable_2", 2)
    @s.rb_cvar_get(CVTest, "@@class_variable_2").should == 2
  end

  it "rb_cv_get should get a class variable" do
    @s.rb_cv_set(CVTest, "@@class_variable_3", 3)
  ...
  it "rb_cv_set should allow changing class variable" do
    @s.rb_cv_set(CVTest, "@@class_variable_4", 4)
    @s.rb_cv_get(CVTest, "@@class_variable_4").should == 4
    @s.rb_cv_set(CVTest, "@@class_variable_4", 5)
    @s.rb_cv_get(CVTest, "@@class_variable_4").should == 5
    @s.rb_cvar_set(CVTest, "@@class_variable_4", 6)
    @s.rb_cvar_get(CVTest, "@@class_variable_4").should == 6
  end
end
