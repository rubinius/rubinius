...
describe "Command::Output::Columns#wrap" do
  ...
  it "raises an ArgumentError if wrap < 1" do
    lambda{ @cols.wrap(nil, 0) }.should raise_error(ArgumentError)
    lambda{ @cols.wrap("here is a string", 0) }.should raise_error(ArgumentError)
  end
