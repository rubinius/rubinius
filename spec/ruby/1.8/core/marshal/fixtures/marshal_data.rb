...
module MarshalSpec
  DATA = {
    ...
    "Fixnum (2**30 - 1)" => [2**30 - 1,
                             "\004\bi\004\377\377\377?"],
    "Fixnum 2**16" => [2**16,
                       "\004\bi\003\000\000\001"],
    "Fixnum -2**16" => [-2**16,
                        "\004\bi\376\000\000"],
    "Fixnum -(2**16 - 1)" => [-(2**16 - 1),
                              "\004\bi\376\001\000"],
    "Fixnum -2**30" => [-2**30,
                        "\004\bi\374\000\000\000\300"],
    "Bignum 2**30" => [2**30,
                       "\004\bl+\a\000\000\000@"],
    "Bignum -(2**31 - 1)" => [-(2**31 - 1),
                              "\004\bl-\a\377\377\377\177"],
    "Bignum 2**40" => [2**40,
                       "\004\bl+\b\000\000\000\000\000\001"],
    "Bignum -2**63" => [-2**63,
    ...
    "Struct" => [Struct.new("Ure0").new,
                 "\004\bS:\021Struct::Ure0\000"],
  }
end
