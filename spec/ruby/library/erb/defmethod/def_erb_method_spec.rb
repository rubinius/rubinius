...
END
  ...
  it "defines method to render eRuby file as an instance method of current module" do
    expected = <<'END'
...
END
  ...
  it "defines method to render eRuby object as an instance method of current module" do
    expected = <<'END'
<b>10</b>
<b>20</b>
<b>30</b>
