...
#define	Balloc		__Balloc_rbx_D2A
#define	Bfree		__Bfree_rbx_D2A
#define	ULtoQ		__ULtoQ_rbx_D2A
#define	ULtof		__ULtof_rbx_D2A
#define	ULtod		__ULtod_rbx_D2A
#define	ULtodd		__ULtodd_rbx_D2A
#define	ULtox		__ULtox_rbx_D2A
#define	ULtoxL		__ULtoxL_rbx_D2A
#define	any_on		__any_on_rbx_D2A
#define	b2d		__b2d_rbx_D2A
#define	bigtens		__bigtens_rbx_D2A
#define	cmp		__cmp_rbx_D2A
#define	copybits	__copybits_rbx_D2A
#define	d2b		__d2b_rbx_D2A
#define	decrement	__decrement_rbx_D2A
#define	diff		__diff_rbx_D2A
#define	dtoa_result	__dtoa_result_rbx_D2A
#define	g__fmt		__g__fmt_rbx_D2A
#define	gethex		__gethex_rbx_D2A
#define	hexdig		__hexdig_rbx_D2A
#define	hexdig_init_D2A	__hexdig_init_rbx_D2A
#define	hexnan		__hexnan_rbx_D2A
#define	hi0bits		__hi0bits_rbx_D2A
#define	hi0bits_D2A	__hi0bits_rbx_D2A
#define	i2b		__i2b_rbx_D2A
#define	increment	__increment_rbx_D2A
#define	lo0bits		__lo0bits_rbx_D2A
#define	lshift		__lshift_rbx_D2A
#define	match		__match_rbx_D2A
#define	mult		__mult_rbx_D2A
#define	multadd		__multadd_rbx_D2A
#define	nrv_alloc	__nrv_alloc_rbx_D2A
#define	pow5mult	__pow5mult_rbx_D2A
#define	quorem		__quorem_rbx_D2A
#define	ratio		__ratio_rbx_D2A
#define	rshift		__rshift_rbx_D2A
#define	rv_alloc	__rv_alloc_rbx_D2A
#define	s2b		__s2b_rbx_D2A
#define	set_ones	__set_ones_rbx_D2A
#define	strcp		__strcp_rbx_D2A
#define	strcp_D2A      	__strcp_rbx_D2A
#define	strtoIg		__strtoIg_rbx_D2A
#define	sum		__sum_rbx_D2A
#define	tens		__tens_rbx_D2A
#define	tinytens	__tinytens_rbx_D2A
#define	tinytens	__tinytens_rbx_D2A
#define	trailz		__trailz_rbx_D2A
#define	ulp		__ulp_rbx_D2A
