...
module Rubinius
  module FFI
    ...
    module Library
      ...
      def ffi_libraries
        @ffi_lib || [DynamicLibrary::CURRENT_PROCESS]
      end
      ...
      def attach_variable(mname, a1, a2=nil)
        ...
        if type.kind_of?(Class) && type.ancestors.include?(FFI::Struct)
          c = type.new(ptr)
      ...
      def find_type(name)
        ...
        if name.kind_of?(Rubinius::NativeFunction) || name.kind_of?(FFI::Enum)
          return name
        end
