...
class InstructionSet
  ...
  OpCodes = [
    ...
    {:opcode => :soft_return, :args => [], :stack => [1,0], :flow => :return,
      :vm_flags => [:terminator]},
    {:opcode => :caller_return, :args => [], :stack => [1,0], :flow => :return,
      :vm_flags => [:terminator]},
    ...
    {:opcode => :block_break, :args => [], :stack => [0,0], :flow => :return,
      :vm_flags => [:terminator]},
    ...
    {:opcode => :meta_send_stack_1, :args => [:literal], :stack => [2,1],
      :flow => :send, :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_stack_2, :args => [:literal], :stack => [3,1],
      :flow => :send, :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_stack_3, :args => [:literal], :stack => [4,1],
      :flow => :send, :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_stack_4, :args => [:literal], :stack => [5,1],
      :flow => :send, :vm_flags => [:check_interrupts]},
