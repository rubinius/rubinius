...
class InstructionSet
  ...
  OpCodes = [
    ...
    {:opcode => :allocate, :args => [], :stack => [1,1], :vm_flags => [:check_interrupts]},
    ...
    {:opcode => :send_primitive, :args => [:primitive, :int], :stack => [-121,1], :vm_flags => [:check_interrupts]},
    {:opcode => :push_context, :args => [], :stack => [0,1]},
    {:opcode => :push_literal, :args => [:literal], :stack => [0,1]},
    {:opcode => :push_self, :args => [], :stack => [0,1]},
    {:opcode => :goto, :args => [:ip], :stack => [0,0]},
    {:opcode => :goto_if_false, :args => [:ip], :stack => [1,0]},
    {:opcode => :goto_if_true, :args => [:ip], :stack => [1,0]},
    ...
    {:opcode => :make_array, :args => [:int], :stack => [-110,1], :vm_flags => [:check_interrupts]},
    {:opcode => :set_ivar, :args => [:literal], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :push_ivar, :args => [:literal], :stack => [0,1]},
    {:opcode => :goto_if_defined, :args => [:ip], :stack => [1,0]},
    {:opcode => :push_const, :args => [:literal], :stack => [0,1]},
    {:opcode => :set_const, :args => [:literal], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :set_const_at, :args => [:literal], :stack => [2,0], :vm_flags => [:check_interrupts]},
    {:opcode => :find_const, :args => [:literal], :stack => [1,1]},
    {:opcode => :attach_method, :args => [:literal], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :add_method, :args => [:literal], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :open_class, :args => [:literal], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :open_class_under, :args => [:literal], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :open_module, :args => [:literal], :stack => [0,1], :vm_flags => [:check_interrupts]},
    {:opcode => :open_module_under, :args => [:literal], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :unshift_tuple, :args => [], :stack => [1,2], :vm_flags => [:check_interrupts]},
    {:opcode => :cast_tuple, :args => [], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :make_rest, :args => [:int], :stack => [-110,1], :vm_flags => [:check_interrupts]},
    {:opcode => :dup_top, :args => [], :stack => [0,1]},
    {:opcode => :pop, :args => [], :stack => [1,0]},
    {:opcode => :ret, :args => [], :stack => [1,0], :vm_flags => [:terminator]},
    {:opcode => :send_method, :args => [:literal], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :send_stack, :args => [:literal, :int], :stack => [-121,1], :vm_flags => [:check_interrupts]},
    {:opcode => :send_stack_with_block, :args => [:literal, :int], :stack => [-122,1], :vm_flags => [:check_interrupts]},
    {:opcode => :push_block, :args => [], :stack => [0,1]},
    {:opcode => :clear_exception, :args => [], :stack => [0,0]},
    {:opcode => :soft_return, :args => [], :stack => [1,0], :vm_flags => [:terminator]},
    {:opcode => :caller_return, :args => [], :stack => [1,0], :vm_flags => [:terminator]},
    {:opcode => :push_array, :args => [], :stack => [1,-999]},
    {:opcode => :cast_array, :args => [], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :make_hash, :args => [:int], :stack => [-210,1], :vm_flags => [:check_interrupts]},
    {:opcode => :raise_exc, :args => [], :stack => [1,0], :vm_flags => [:terminator]},
    {:opcode => :set_encloser, :args => [], :stack => [1,0]},
    {:opcode => :push_encloser, :args => [], :stack => [0,0]},
    {:opcode => :activate_method, :args => [:int], :stack => [-115,1], :vm_flags => [:check_interrupts]},
    {:opcode => :push_cpath_top, :args => [], :stack => [0,1]},
    {:opcode => :check_argcount, :args => [:int, :int], :stack => [0,0], :vm_flags => [:terminator]},
    {:opcode => :passed_arg, :args => [:int], :stack => [0,1]},
    {:opcode => :string_append, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :string_dup, :args => [], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :set_args, :args => [], :stack => [1,0]},
    {:opcode => :get_args, :args => [], :stack => [0,1]},
    {:opcode => :send_with_arg_register, :args => [:literal], :stack => [-132,1], :vm_flags => [:check_interrupts]},
    {:opcode => :cast_array_for_args, :args => [:int], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :send_super_stack_with_block,  :args => [:literal, :int], :stack => [-121,1], :vm_flags => [:check_interrupts]},
    {:opcode => :push_my_field, :args => [:field], :stack => [0,1]},
    {:opcode => :store_my_field, :args => [:field], :stack => [1,1]},
    {:opcode => :open_metaclass, :args => [], :stack => [1,1]},
    {:opcode => :set_cache_index, :args => [:cache], :stack => [0,0]},
    {:opcode => :block_break, :args => [], :stack => [0,0], :vm_flags => [:terminator]},
    {:opcode => :send_super_with_arg_register, :args => [:literal], :stack => [-131,1]},
    ...
    {:opcode => :meta_send_stack_1, :args => [:literal], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_stack_2, :args => [:literal], :stack => [3,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_stack_3, :args => [:literal], :stack => [4,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_stack_4, :args => [:literal], :stack => [5,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_plus, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_minus, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_equal, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_lt, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_gt, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_tequal, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :meta_send_op_nequal, :args => [], :stack => [2,1], :vm_flags => [:check_interrupts]},
    {:opcode => :push_local_depth, :args => [:depth, :enclosed_local], :stack => [0,1]},
    {:opcode => :set_local_depth, :args => [:depth, :enclosed_local], :stack => [1,1], :vm_flags => [:check_interrupts]},
    {:opcode => :create_block, :args => [:int], :stack => [3,1], :vm_flags => [:check_interrupts]},
    {:opcode => :send_off_stack, :args => [], :stack => [-133,1], :vm_flags => [:check_interrupts]},
    ...
    {:opcode => :yield_debugger, :args => [], :stack => [0,0], :vm_flags => [:check_interrupts]},
    {:opcode => :from_fp, :args => [:int], :stack => [0,1]},
    {:opcode => :set_local_from_fp, :args => [:local, :int], :stack => [0,0]},
    {:opcode => :make_rest_fp, :args => [:int], :stack => [0,1], :vm_flags => [:check_interrupts]},
    ...
    {:opcode => :get_local_fp, :args => [:int], :stack => [0,1]},
    ...
    {:opcode => :sret, :args => [], :stack => [1,0], :vm_flags => [:terminator]},
    {:opcode => :set_literal, :args => [:literal], :stack => [0,0]},
    {:opcode => :passed_blockarg, :args => [:int], :stack => [0,1]},
    {:opcode => :create_block2, :args => [], :stack => [1,1], :vm_flags => [:check_interrupts]},
