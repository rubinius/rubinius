class Compiler
  module Bootstrap
    ...
    :CompiledMethod=>{:@__ivars__=>0, :@primitive => 1, :@required=>2, :@serial=>3, :@bytecodes=>4, :@name=>5, :@file=>6, :@local_count=>7, :@literals=>8, :@args=>9, :@exceptions=>11, :@lines=>12, :@path=>13, :@bonus => 15, :@compiled => 16, :@staticscope => 17},
