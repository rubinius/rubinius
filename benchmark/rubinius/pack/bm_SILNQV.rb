...
Benchmark.bmbm do |x|
  ...
  x.report("[S].pack('I')") do
    total.times { S.pack("I") }
  end
  ...
  x.report("[M].pack('I*')") do
    total.times { M.pack("I*") }
  end

  x.report("[L].pack('S*')") do
    total.times { L.pack("S*") }
  end

  x.report("[L].pack('I*')") do
    total.times { L.pack("I*") }
  end

  x.report("[L].pack('L*')") do
    total.times { L.pack("L*") }
  end

  x.report("[L].pack('N*')") do
    total.times { L.pack("N*") }
  end

  x.report("[L].pack('V*')") do
    total.times { L.pack("V*") }
  end

  x.report("[L].pack('Q*')") do
    total.times { L.pack("Q*") }
  end

  x.report("[X].pack('I*')") do
    total.times { X.pack("I*") }
  end
end
