...
Benchmark.bmbm do |x|
  ...
  x.report("S.unpack('C0')") do
    total.times { S.unpack("C0") }
  end

  x.report("S.unpack('C')") do
    total.times { S.unpack("C") }
  end

  x.report("S.unpack('C1')") do
    total.times { S.unpack("C1") }
  end

  x.report("S.unpack('C3')") do
    total.times { S.unpack("C3") }
  end

  x.report("S.unpack('C5')") do
    total.times { S.unpack("C5") }
  end

  x.report("S.unpack('C1C1C1C1C1')") do
    total.times { S.unpack("C1C1C1C1C1") }
  end
  ...
  x.report("M.unpack('C*')") do
    total.times { M.unpack("C*") }
  end

  x.report("L.unpack('C*')") do
    total.times { L.unpack("C*") }
  end

  x.report("X.unpack('C*')") do
    total.times { X.unpack("C*") }
  end
end
