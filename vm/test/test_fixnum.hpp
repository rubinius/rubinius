...
class TestFixnum : public CxxTest::TestSuite {
  ...
  void test_add_a_bignum() {
    ...
    Bignum* obj = Bignum::create(state, (native_int)FIXNUM_MAX - 10);
  ...
  void test_sub_a_bignum() {
    FIXNUM one  = as<Fixnum>(Fixnum::from(13));
    Bignum* obj = Bignum::create(state, (native_int)FIXNUM_MAX + 28);
  ...
  void test_mul_with_bignum() {
    ...
    Bignum* two   = Bignum::create(state, (native_int)FIXNUM_MAX + 10);
  ...
  void test_div_a_bignum() {
    FIXNUM one = Fixnum::from(13);
    INTEGER res = one->div(state, Bignum::create(state, (native_int)FIXNUM_MAX + 10));
    TS_ASSERT_EQUALS(res->n2i(), 0);

    TS_ASSERT_THROWS( one->div(state, Bignum::create(state, (native_int)0)), const ZeroDivisionError &);
  }
  ...
  void test_mod_with_a_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from(-3)->mod(state, Bignum::create(state, (native_int)-2)), Fixnum::from(-1));
  }
  ...
  void test_divmod_with_a_bignum() {
    FIXNUM one = as<Fixnum>(Fixnum::from(15));
    Bignum* two = Bignum::create(state, (native_int)4);
  ...
  void test_equal_with_a_bignum() {
    Bignum* obj1 = Bignum::create(state, (native_int)10);
    Bignum* obj2 = Bignum::create(state, (native_int)11);
  ...
  void test_compare_with_a_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from(3)->compare(state, Bignum::create(state, (native_int)2)), Fixnum::from(1));
    TS_ASSERT_EQUALS(Fixnum::from(3)->compare(state, Bignum::create(state, (native_int)3)), Fixnum::from(0));
    TS_ASSERT_EQUALS(Fixnum::from(3)->compare(state, Bignum::create(state, (native_int)4)), Fixnum::from(-1));
  }
  ...
  void test_gt_with_a_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from(3)->gt(state, Bignum::create(state, (native_int)2)), Qtrue);
    TS_ASSERT_EQUALS(Fixnum::from(3)->gt(state, Bignum::create(state, (native_int)3)), Qfalse);
  }
  ...
  void test_ge_with_a_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from(3)->ge(state, Bignum::create(state, (native_int)2)), Qtrue);
    TS_ASSERT_EQUALS(Fixnum::from(3)->ge(state, Bignum::create(state, (native_int)3)), Qtrue);
    TS_ASSERT_EQUALS(Fixnum::from(3)->ge(state, Bignum::create(state, (native_int)4)), Qfalse);
  }
  ...
  void test_lt_with_a_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from(3)->lt(state, Bignum::create(state, (native_int)4)), Qtrue);
    TS_ASSERT_EQUALS(Fixnum::from(3)->lt(state, Bignum::create(state, (native_int)3)), Qfalse);
  }
  ...
  void test_le_with_a_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from(3)->le(state, Bignum::create(state, (native_int)4)), Qtrue);
    TS_ASSERT_EQUALS(Fixnum::from(3)->le(state, Bignum::create(state, (native_int)3)), Qtrue);
    TS_ASSERT_EQUALS(Fixnum::from(3)->le(state, Bignum::create(state, (native_int)2)), Qfalse);
  }
  ...
  void test_size() {
    TS_ASSERT_EQUALS(static_cast<unsigned int>(Fixnum::from(0)->size(state)->n2i()), 
		     sizeof(native_int));
  }
  ...
  void test_and_with_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from( 5)->bit_and(state, Bignum::create(state, (native_int) 3)), Fixnum::from( 1));
    TS_ASSERT_EQUALS(Fixnum::from(-5)->bit_and(state, Bignum::create(state, (native_int) 3)), Fixnum::from( 3));
    TS_ASSERT_EQUALS(Fixnum::from( 5)->bit_and(state, Bignum::create(state, (native_int)-3)), Fixnum::from( 5));
    TS_ASSERT_EQUALS(Fixnum::from(-5)->bit_and(state, Bignum::create(state, (native_int)-3)), Fixnum::from(-7));
  }
  ...
  void test_or_with_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from( 5)->bit_or(state, Bignum::create(state, (native_int) 3)), Fixnum::from( 7));
    TS_ASSERT_EQUALS(Fixnum::from(-5)->bit_or(state, Bignum::create(state, (native_int) 3)), Fixnum::from(-5));
    TS_ASSERT_EQUALS(Fixnum::from( 5)->bit_or(state, Bignum::create(state, (native_int)-3)), Fixnum::from(-3));
    TS_ASSERT_EQUALS(Fixnum::from(-5)->bit_or(state, Bignum::create(state, (native_int)-3)), Fixnum::from(-1));
  }
  ...
  void test_xor_with_bignum() {
    TS_ASSERT_EQUALS(Fixnum::from( 5)->bit_xor(state, Bignum::create(state, (native_int) 3)), Fixnum::from( 6));
    TS_ASSERT_EQUALS(Fixnum::from(-5)->bit_xor(state, Bignum::create(state, (native_int) 3)), Fixnum::from(-8));
    TS_ASSERT_EQUALS(Fixnum::from( 5)->bit_xor(state, Bignum::create(state, (native_int)-3)), Fixnum::from(-8));
    TS_ASSERT_EQUALS(Fixnum::from(-5)->bit_xor(state, Bignum::create(state, (native_int)-3)), Fixnum::from( 6));
  }
